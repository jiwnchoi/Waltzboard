...
const margin = { top: 20, bottom: 0, left: 15, right: 10 };
...
const StackedBarChart = ({
  ...
  console.log(title, t["sect-chart_types"], title !== t["sect-chart_types"]);
  return (
    <Box>
      <Flex
        flexDir={"row"}
      ...
      <Box w="full" maxH={240} overflowY={"scroll"}>
...
const SpaceDistView = (props: FlexProps) => {
  ...
  return (
    <Flex {...props} flexDir={"column"}>
      <StackedBarChart title={t["sect-chart_types"]} svgProp={chartTypeProp} />
      <StackedBarChart
        title={t["sect-transformations"]}
        svgProp={transformationProp}
      />
      <StackedBarChart title={t["sect-attributes"]} svgProp={attributeProp} />
    </Flex>
  );
};
