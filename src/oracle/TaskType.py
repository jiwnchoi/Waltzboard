...
task_types: dict[str, TaskType] = {
    "retrieve": TaskType(
        "Retrieve Value",
        OracleWeight(coverage=2, uniqueness=-1, specificity=2, interestingness=0),
        [chart_types["scatter"], chart_types["heatmap"]],
    ),
    "correaltion": TaskType(
        "Correlation",
        OracleWeight(coverage=0, uniqueness=2, specificity=1, interestingness=2),
        [chart_types["scatter"], chart_types["heatmap"]],
    ),
    "compare": TaskType(
        "Compare",
        OracleWeight(coverage=0, uniqueness=2, specificity=2, interestingness=0),
        [
            chart_types["bar"],
            chart_types["line"],
            chart_types["area"],
    ...
    "cluster": TaskType(
        "Cluster",
        OracleWeight(coverage=1, uniqueness=1, specificity=1, interestingness=-2),
        [chart_types["scatter"], chart_types["heatmap"]],
    ),
    "distribution": TaskType(
        "Characterize Distribution",
        OracleWeight(coverage=2, uniqueness=2, specificity=1, interestingness=0),
        [
            chart_types["scatter"],
            chart_types["boxplot"],
    ...
    "derived": TaskType(
        ...
        OracleWeight(coverage=1, uniqueness=2, specificity=2, interestingness=1),
        [
            chart_types["bar"],
            chart_types["line"],
            chart_types["scatter"],
