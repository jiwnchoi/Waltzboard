...
// import { currentScoreSignal, resultDistributionSignal } from '../controller/infer';
// import { weightSignal } from '../controller/oracleWeight';
// type Target = 'score' | 'diversity' | 'coverage' | 'interestingness' | 'specificity';
...
//     let max = 0;
//     let min = 0;
//     if (weightSignal.peek().diversity > 0) {
//       max += weightSignal.peek().diversity;
//     } else {
//       min += weightSignal.peek().diversity;
//     }
